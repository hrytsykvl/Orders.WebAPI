    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("735886c0-faf3-49ca-9776-8a20b756f1cb"), "Jane Smith", new DateTime(2024, 5, 27, 11, 43, 22, 542, DateTimeKind.Local).AddTicks(3873), "ORD002", 225.8m },
                    { new Guid("f4816224-70d6-4491-ac52-34f298ace16f"), "John Doe", new DateTime(2024, 5, 27, 11, 43, 22, 542, DateTimeKind.Local).AddTicks(3814), "ORD001", 66.5m }
                });
        }
