...
namespace Orders.WebAPI.Migrations
{
    ...
    [Migration("20240527084323_Initial")]
            ...
            modelBuilder.Entity("Orders.WebAPI.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OrderDate = new DateTime(2024, 5, 27, 11, 43, 22, 542, DateTimeKind.Local).AddTicks(3814),
                            OrderNumber = "ORD001",
                            TotalAmount = 66.5m
                        },
                        new
                        {
                            ...
                            OrderDate = new DateTime(2024, 5, 27, 11, 43, 22, 542, DateTimeKind.Local).AddTicks(3873),
                            OrderNumber = "ORD002",
                            TotalAmount = 225.8m
                        });
                });
